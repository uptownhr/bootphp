...
class Jien_Scaffold {
	...
	public function generateAdminEditView($model){
		...
		foreach($schema AS $field=>$value){
			...
			$edit_fields .= '<div class="control-group">
								<label class="control-label">'.$label.'</label>
								<div class="controls">
									<input class="large" name="'.$field.'" value="<?php echo $this->data->row("'.$field.'") ? $this->data->row("'.$field.'") : ""; ?>" type="text">
								</div>
							</div>' . "\r\n";
		}
